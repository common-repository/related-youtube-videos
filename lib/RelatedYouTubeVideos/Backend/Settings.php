...
class RelatedYouTubeVideos_Backend_Settings extends Meomundo_WP {
  ...
  public function __construct( $absolutePluginPath, $pluginURL, $pluginSlug ) {
    ...
    $this->nonceAction = "nonceRytvSettingsForm";
  ...
  public function controller() {
    ...
    if( isset( $_POST['rytv_settings_status'] ) && (int) $_POST['rytv_settings_status'] === 1 && check_admin_referer( $this->nonceAction ) ) {
  ...
  public function viewSettingsForm() {
    ...
    $cachetime        = ( isset( $options['cachetime'] ) )    ? (int) $options['cachetime'] : 24;
    ...
    $html .= wp_nonce_field( $this->nonceAction, "_wpnonce", null, false );
    ...
    $html .= '  <td><input type="text" name="rytv_settings_devKey" id="rytv_settings_devKey" value="' . htmlspecialchars( $devKey, ENT_COMPAT ) . '" /></td>' . "\n";
    $html .= " </tr>\n";
    ...
    $html .= '  <td><input type="text" name="rytv_settings_customMessage" id="rytv_settings_customMessage" value="' . htmlspecialchars( $customMessage, ENT_COMPAT ) . '" /></td>' . "\n";
    $html .= " </tr>\n";
